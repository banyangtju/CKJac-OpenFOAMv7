...
LoadBalanced_pyJacChemistryModel<ReactionThermo, ThermoType>::
...
template<class ReactionThermo, class ThermoType>
LoadBalanced_pyJacChemistryModel<ReactionThermo, ThermoType>::~LoadBalanced_pyJacChemistryModel() {}

template<class ReactionThermo, class ThermoType>
void LoadBalanced_pyJacChemistryModel<ReactionThermo, ThermoType>::jacobian
(
	const scalar t, 
	const scalarField& c, 
//	const label li, 
...
template<class ReactionThermo, class ThermoType>
void LoadBalanced_pyJacChemistryModel<ReactionThermo, ThermoType>::derivatives
(
	const scalar t, 
	const scalarField& c, 
//	const label li, 
...
LoadBalanced_pyJacChemistryModel<ReactionThermo, ThermoType>::Qdot() const 
{
...
template<class ReactionThermo, class ThermoType>
void Foam::LoadBalanced_pyJacChemistryModel<ReactionThermo, ThermoType>::updateReactionRate
(
...
template<class ReactionThermo, class ThermoType>
Foam::scalarField Foam::LoadBalanced_pyJacChemistryModel<ReactionThermo, ThermoType>::getVariable
(
